...
const HomeGalleryForm = () => {
    ...
    const fetchDetails = async () => {
        try {
            ...
            const response = await fetch(`https://api.harekrishnavidya.org/api/home-gallery/${id}`);
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const url = isEditMode ? `https://api.harekrishnavidya.org/api/home-gallery/${id}` : 'https://api.harekrishnavidya.org/api/home-gallery';
        ...
        <div className="min-h-screen bg-gray-50">
            <div className="bg-white border-b px-6 py-4 flex items-center justify-between">
                <div className="flex items-center gap-4">
                    <button onClick={() => navigate('/home-gallery')} className="text-gray-600"><FaArrowLeft /></button>
                    <h1 className="text-xl font-bold">{isEditMode ? 'Edit Home Item' : 'Add Home Item'}</h1>
                </div>
